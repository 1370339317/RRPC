...
func NewLpcstub(client *Client) *Lpcstub {
	return &Lpcstub{client: client}
}

func (pthis *Lpcstub) ToUpper(s string, a1 int, a2 int, a3 int) (string, error) {
...
func (pthis *Lpcstub) Add(a int, b int) (int, error) {
...
func (pthis *Lpcstub) Add2(a int, b int) (int, int, error) {
...
func (pthis *Lpcstub) TestRPCFunc(arg1 int, arg2 float64, arg3 string, arg4 bool, arg5 []int, arg6 *string, arg7 CustomType, arg8 *CustomType) (int, *float64, string, bool, []int, *string, CustomType, *CustomType, error, error) {
